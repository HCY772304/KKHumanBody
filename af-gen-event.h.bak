...
#define EMBER_AF_GENERATED_EVENT_STRINGS   \
  ...
  "Ikk net join faild1 event control",  \
  "Ikk net join faild2 event control",  \
  "Ikk rtt msg dispatch event control",  \
  "Ikk rtt recv loop check event control",  \
  "Ikk rtt sent loop check event control",  \
  "Ikk uart msg dispatch event control",  \
  "Ikk uart recv loop check event control",  \
  "Ikk uart sent loop check event control",  \
  "K connect delay report event control",  \
  "K delay set led status event control",  \
  "K factory test event control",  \
  "K get battery voltage event control",  \
  "K nwk rejoin procedure event control",  \
  "K opt tunnel mto r r delay rsp event control",  \
  "K set first jion flg event control",  \
  "K tick event control",  \
  "K user join succeed procedure event control",  \
  "Kk delay send mfg msg event control",  \
  "Kk mfglib start event control",  \
  "Kk mfglib stop event control",  \
  "Kk mfglib wait receive event control",  \
