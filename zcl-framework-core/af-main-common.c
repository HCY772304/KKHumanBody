...
#include "../zcl-framework-core_inc/service-discovery.h"

#include "app/framework/util/common.h"

// determines the number of in-clusters and out-clusters based on defines
// in config.h
#include "../zcl-framework-core_inc/af-main.h"

#include "../zcl-framework-core_inc/attribute-storage.h"
#include "../zcl-framework-core_inc/attribute-table.h"
#include "../zcl-framework-core_inc/util.h"
#include "callback.h"
#include "../zcl-framework-core_inc/print.h"
#include "../zcl-framework-core_inc/config.h"
...
//      if (!MEMCOMPARE(eui64GatewayAddr, binding.identifier, EUI64_SIZE)){
  ...
  kZclClusterSetPermitReportInfo(endpoint_mark, zclReportInfo.clusterId, zclReportInfo.reportEnable, zclReportInfo.sceneRecallFlg, zclReportInfo.reportGatewayEnable, false);
  }
