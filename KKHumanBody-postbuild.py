...
def OTA():
    if not '"%PROJECT_DIR%\..\\developer\\sdks\\v3.1\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 0x12 --manuf-id 0x1268 --image-type 14001 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL KKHumanBody"':
        sys.exit(0)
    print (" ")
    ...
    IMAGE_BUILDER = '"%PROJECT_DIR%\..\\developer\\sdks\\v3.1\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 0x12 --manuf-id 0x1268 --image-type 14001 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL KKHumanBody"'.replace("\t", "\\t")
