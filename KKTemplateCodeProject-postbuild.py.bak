...
def OTA():
    if not '"%PROJECT_DIR%\..\\developer\\sdks\\gecko_sdk_suite\\v3.1\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 0x13 --manuf-id 0x1268 --image-type 20506 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL KKTemplateCodeProject"':
        sys.exit(0)
    print (" ")
    ...
    IMAGE_BUILDER = '"%PROJECT_DIR%\..\\developer\\sdks\\gecko_sdk_suite\\v3.1\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 0x13 --manuf-id 0x1268 --image-type 20506 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL KKTemplateCodeProject"'.replace("\t", "\\t")
